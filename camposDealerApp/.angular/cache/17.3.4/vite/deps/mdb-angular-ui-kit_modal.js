...
var MdbModalContainerComponent = class _MdbModalContainerComponent {
  ...
  static ɵfac = function MdbModalContainerComponent_Factory(t) {
    return new (t || _MdbModalContainerComponent)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ConfigurableFocusTrapFactory), ɵɵdirectiveInject(NgZone));
  };
...
var MdbModalService = class _MdbModalService {
  ...
  static ɵfac = function MdbModalService_Factory(t) {
    return new (t || _MdbModalService)(ɵɵinject(DOCUMENT), ɵɵinject(Overlay), ɵɵinject(Injector), ɵɵinject(ComponentFactoryResolver$1));
  };
